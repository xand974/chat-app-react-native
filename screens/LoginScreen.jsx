...
export default function LoginScreen() {
    ...
    //#region Image url
    const IMG_URL = "https://images.unsplash.com/photo-1518156677180-95a2893f3e9f?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NjV8fHdoaXRlJTIwYmxhY2t8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60"
    //#endregion
    return (
        ...
        elevation: 24,})}>
           ...
           <Text style={tw`text-center text-gray-300 text-sm mb-3 italic`}>Entrez dans la matrice</Text>
              <LogInput placeholder="votre pseudo" />
               ...
               <TouchableOpacity onPress={() => navigation.navigate("RegisterScreen")}>
                   <Text style={tw`text-white text-center border-b-2`}>Créer un compte</Text>
               </TouchableOpacity>
               </View>
           </View>
        </View>
